      ...
      <div className="w-145 h-170  rounded-4xl bg-rose-50">
        ...
        <div>
          <div className="flex flex-col text-center justify-center">
            <h1 className="text-4xl font-semibold text-slate-900 mt-10">
              Ти маєш вибрати <br /> 1 з 3 подарунків,<br /> який ти отримаєш
              сьогодні.
            </h1>
            <h1 className="text-4xl font-semibold text-slate-900 mt-20">
